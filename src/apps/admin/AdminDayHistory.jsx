// src/apps/admin/AdminDayHistory.jsx  (replace your AdminArchive.jsx import/route)
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  type="button"
                  className="px-3 py-1.5 text-sm border rounded-md border-slate-300 text-slate-600 cursor-not-allowed"
                  title="To follow after implementing View Chart new format in BHW and Doctor"
                  disabled
                >
                  View Chart
                </button>
