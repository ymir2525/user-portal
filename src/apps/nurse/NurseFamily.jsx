...
import "./NurseFamily.css";

export default function NurseFamily() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (profErr || !prof || String(prof.role).toUpperCase() !== "NURSE") {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <div className="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between border-b border-slate-200">
        <Link to="/nurse" className="text-indigo-700 hover:text-indigo-900 text-sm font-medium">
          ← Back to Records
        </Link>
