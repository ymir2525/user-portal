  ...
  return (
    <div className="docdash layout">
      ...
      <aside className="sidebar">
        <nav className="nav">
          <NavButton to="/doctor" currentPath={loc.pathname} exact>Dashboard</NavButton>
          <NavButton to="/doctor/queue" currentPath={loc.pathname}>Queueing Table</NavButton>
          <NavButton to="/doctor/patients" currentPath={loc.pathname}>Patient Records</NavButton>
          <NavButton to="/doctor/inventory" currentPath={loc.pathname}>Medicine Inventory</NavButton>
        </nav>
      </aside>
